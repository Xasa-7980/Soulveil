...
namespace MK.Glow
{
	public static class Compatibility
    {
        ...
        {
            return SystemInfo.graphicsShaderLevel >= 35 && SystemInfo.supportedRenderTargetCount >= 2;
        }
        ...
        {
            return SystemInfo.graphicsShaderLevel >= 45 && SystemInfo.supportedRenderTargetCount >= 6;
        }
