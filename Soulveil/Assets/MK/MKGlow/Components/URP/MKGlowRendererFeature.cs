...
namespace MK.Glow.URP
{
    public class MKGlowRendererFeature : ScriptableRendererFeature, MK.Glow.ISettings
    {
		...
		public bool showEditorBloomBehavior = true;
        ...
        partial class MKGlowRenderPass : ScriptableRenderPass, MK.Glow.ICameraData
        #else
        ...
        #endif
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                if(renderingData.cameraData.camera.allowDynamicResolution)
                {
                    ...
                    _passData.cameraWidthRaw = _passData.cameraWidth;
                    _passData.cameraHeightRaw = _passData.cameraHeight;
                }
                else
                {
            ...
            private class PassData
            {
                ...
                public int cameraWidthRaw;
                public int cameraHeightRaw;
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                using (var builder = renderGraph.AddUnsafePass<PassData>(passName, out var passData))
                {
                    ...
                    if(universalCameraData.camera.allowDynamicResolution)
                    {
                        ...
                        passData.cameraWidthRaw = _passData.cameraWidth;
                        passData.cameraHeightRaw = _passData.cameraHeight;
                    }
                    else
                    {
            ...
            public int GetCameraWidthRaw()
            {
                return _passData.cameraWidth;
            }
            public int GetCameraHeightRaw()
            {
                return _passData.cameraHeight;
            }
