...
namespace RLD
{
    ...
    public class RTObjectSelection : MonoSingleton<RTObjectSelection>
    {
        ...
        private bool _ignoreNextObjectPick = false;
        public void SetSelectedObjects(List<GameObject> gameObjects, bool allowUndoRedo)
        {
            ...
            if (RTInputDevice.Get.Device.IsButtonPressed(_objectPickDeviceBtnIndex))
                _ignoreNextObjectPick = true;
        }
        ...
        public void EndManipSession()
        {
            if (ActiveManipSession == ObjectSelectionManipSession.None) return;
        ...
        private void OnInputDevicePickButtonUp()
        {
            ...
            if (_ignoreNextObjectPick)
            {
                _ignoreNextObjectPick = false;
                return;
            }
