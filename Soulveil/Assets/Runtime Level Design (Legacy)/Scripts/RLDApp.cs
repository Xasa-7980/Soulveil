...
namespace RLD
{
    ...
    public class RLDApp : MonoSingleton<RLDApp>, IRLDApplication
    {
        ...
        private void OnRenderObject()
        {
            ...
            // Note: Not clear if this is really needed. Could be necessary when prefab previews are generated at runtime.
        ...
        private static void DestroyAppAndModules()
        {
            ...
            {
                var allModulesInScene = GameObjectEx.FindObjectsByType(moduleType);
