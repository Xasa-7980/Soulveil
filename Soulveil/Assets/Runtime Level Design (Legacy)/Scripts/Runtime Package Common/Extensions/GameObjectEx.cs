...
namespace RLD
{
    public static class GameObjectEx
    {
        ...
        {
#if UNITY_6000_0_OR_NEWER
            return MonoBehaviour.FindObjectsByType<T>(FindObjectsSortMode.None);
#else
            return MonoBehaviour.FindObjectsOfType<T>();
#endif
        }
        ...
        {
#if UNITY_6000_0_OR_NEWER
            return MonoBehaviour.FindObjectsByType(type, FindObjectsSortMode.None);
#else
