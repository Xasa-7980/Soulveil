...
namespace RLD
{
    ...
    public class RTPrefabLibDb : MonoSingleton<RTPrefabLibDb>
    {
        ...
        {
            _runtimeUI = GameObjectEx.FindFirstObjectByType<RTPrefabLibDbUI>();
            if (_runtimeUI == null)
            {
            ...
            var eventSystem = GameObjectEx.FindFirstObjectByType<EventSystem>();
            if (eventSystem == null)
            {
        ...
        #if UNITY_EDITOR
        private bool _needsPreviewRefresh = true;
        private void OnSceneGUI(SceneView sceneView)
        {
            if (_needsPreviewRefresh)
            {
                RefreshEditorPrefabPreviews();
